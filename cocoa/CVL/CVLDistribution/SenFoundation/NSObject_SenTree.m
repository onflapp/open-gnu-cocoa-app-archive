/*$Id: NSObject_SenTree.m,v 1.20 2005/09/15 12:34:44 phink Exp $*/
...
{
    return [SenTreeEnumerator enumeratorWithTree:(id <SenTrees, NSObject>)self traversalType:traversalType];
}
