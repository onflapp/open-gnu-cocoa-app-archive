...
#ifndef VHF_H_DXFEXPORTSUB
#define VHF_H_DXFEXPORTSUB

#include <AppKit/AppKit.h>
#include <VHFExport/DXFExport.h>

@interface DXFExportSub:DXFExport
{
