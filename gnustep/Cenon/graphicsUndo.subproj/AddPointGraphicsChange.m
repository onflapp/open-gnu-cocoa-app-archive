...
@interface AddPointGraphicsChange(PrivateMethods)

- (BOOL)subsumeIdenticalChange:change;

@end

@implementation AddPointGraphicsChange

- initGraphicView:aGraphicView point:(NSPoint)pt
{
...
{
    return [AddPointChangeDetail class];
}
