...
#ifndef VHF_H_MOVELAYERGRAPHICSCHANGE
#define VHF_H_MOVELAYERGRAPHICSCHANGE

#include	"../LayerObject.h"

@interface MoveLayerGraphicsChange: Change
{
    id 			graphicView;
...
#endif // VHF_H_MOVELAYERGRAPHICSCHANGE
