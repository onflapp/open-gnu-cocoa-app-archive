...
PROJECT=~/Projects/Libraries/VHFShared		# project directory (the directory we have to copy)
ARCHIVE=/Network/vhfInterservice/Projects/Libraries/VHFShared	# archive directory
...
# update Cenon
PROJECTS=~/Projects
SHARED=$PROJECTS/Libraries/VHFShared
